...
try:
    ...
    from scripts.prompts import (
        ...
        INDUSTRY_ANALYSIS_USER_PROMPT_TEMPLATE,
        PRODUCT_DESCRIPTION_ENHANCEMENT_SYSTEM_PROMPT,
        PRODUCT_DESCRIPTION_ENHANCEMENT_USER_PROMPT_TEMPLATE,
        # 英文提示词
...
class BaseLLMProvider:
    ...
    # 新增SEO优化提示词
    INDUSTRY_ANALYSIS_SYSTEM_PROMPT = INDUSTRY_ANALYSIS_SYSTEM_PROMPT
    INDUSTRY_ANALYSIS_USER_PROMPT_TEMPLATE = INDUSTRY_ANALYSIS_USER_PROMPT_TEMPLATE
    PRODUCT_DESCRIPTION_ENHANCEMENT_SYSTEM_PROMPT = PRODUCT_DESCRIPTION_ENHANCEMENT_SYSTEM_PROMPT
    PRODUCT_DESCRIPTION_ENHANCEMENT_USER_PROMPT_TEMPLATE = PRODUCT_DESCRIPTION_ENHANCEMENT_USER_PROMPT_TEMPLATE
